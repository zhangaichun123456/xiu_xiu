<template>
  <div class="otherorg">
    <p class="headtip">各级、各类政府机构、事业单位；如：民政、公安机关、司法、市政、工商、交通、旅游、医院、教育、学校等机构</p>
    <Form ref="teamValidate" :model="formItem" :label-width="210" :rules="ruleCustom">
        <Form-item prop="teamname" label="政府/单位全称：">
           <Input v-model="formItem.teamname" placeholder="请填写组织机构代码证/事业单位法人证书/统一社会信用代码证书上的名称" style="width: 500px"></Input>
        </Form-item>
        ...
        <Form-item label="证件类型：">
              ...
              <Radio label="multicard">
                <span>事业单位法人证书或统一社会信用代码证书(证书上已有18位的"统一社会信用代码")</span>
              </Radio>
              <Radio label="ordinary">
                <span>组织机构代码证(未办理"多证合一"，证书上没有18位的"统一社会信用代码")</span>
              </Radio>
          </Radio-group>
          </Form-item>
        ...
        <Form-item prop="Reginumber" v-show="formItem.Certifitype=='ordinary'" label="组织机构代码：">
           <Input v-model="formItem.Reginumber" placeholder="请填写组织机构代码号,一般格式为12345678-9" style="width: 400px"></Input>
        </Form-item>
          <Form-item :label='typetoggle'>
...
export default{
  data (){
    ...
    return {
      ...
      ruleCustom:{
                 ...
                 teamname:[
                     { required: true, message: '请填写相关证书上的名称', trigger: 'blur' },
                 ],
                 province:[
  ...
  computed:{
        typetoggle:function (){
          if(this.formItem.Certifitype=='multicard'){
                return '事业单位法人证书/统一社会信用代码证书图片：';
          }else{
                return '组织机构代码证图片：'
          }
        }
